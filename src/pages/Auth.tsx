...
const Auth = () => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    if (error) {
      toast({
        ...
        description: error.message === 'Invalid login credentials' ? "البريد الإلكتروني أو كلمة المرور غير صحيحة" : "حدث خطأ غير متوقع. يرجى المحاولة مرة أخرى",
        variant: "destructive"
      });
    } else {
      toast({
  ...
  return <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4" dir="rtl">
      <div className="absolute inset-0 bg-gradient-glass"></div>
      
      {/* Back Button */}
      <div className="absolute top-6 left-6 z-30">
        <Button variant="ghost" size="sm" onClick={() => navigate('/dashboard')} className="w-12 h-12 p-0 bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/20 transition-all group">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-slide-up">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-primary/10 border border-primary/20 shadow-glow mb-6 animate-glow-pulse rounded-none">
        ...
        {/* Auth Card */}
        <Card className="bg-gradient-glass backdrop-blur-xl border border-white/10 shadow-elevated animate-slide-up" style={{
        animationDelay: '0.2s',
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="signin-email" type="email" placeholder="أدخل بريدك الإلكتروني" value={signInData.email} onChange={e => setSignInData(prev => ({
                      ...prev,
                      email: e.target.value
                    }))} className="pr-10 bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:border-primary focus:bg-white/20" disabled={isLoading} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="signin-password" type="password" placeholder="أدخل كلمة المرور" value={signInData.password} onChange={e => setSignInData(prev => ({
                      ...prev,
                  ...
                  <Button type="submit" className="w-full bg-gradient-primary hover:opacity-90 text-white font-semibold py-3 shadow-soft" disabled={isLoading}>
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="signup-name" type="text" placeholder="أدخل اسمك الكامل" value={signUpData.fullName} onChange={e => setSignUpData(prev => ({
                      ...prev,
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Mail className="absolute right-3 top-3 h-4 w-4 text-white/60" />
                      <Input id="signup-email" type="email" placeholder="أدخل بريدك الإلكتروني" value={signUpData.email} onChange={e => setSignUpData(prev => ({
                      ...prev,
                      email: e.target.value
                    }))} className="pr-10 bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:border-primary focus:bg-white/20" disabled={isLoading} />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Lock className="absolute right-3 top-3 h-4 w-4 text-white/60" />
                      <Input id="signup-password" type="password" placeholder="أدخل كلمة المرور" value={signUpData.password} onChange={e => setSignUpData(prev => ({
                      ...prev,
                      password: e.target.value
                    }))} className="pr-10 bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:border-primary focus:bg-white/20" disabled={isLoading} />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="signup-confirm-password" type="password" placeholder="أعد إدخال كلمة المرور" value={signUpData.confirmPassword} onChange={e => setSignUpData(prev => ({
                      ...prev,
                  ...
                  <Button type="submit" className="w-full bg-gradient-secondary hover:opacity-90 text-white font-semibold py-3 shadow-soft" disabled={isLoading}>
        ...
        {/* Back to Auth */}
        <div className="text-center mt-6 animate-slide-up" style={{
        animationDelay: '0.4s',
        animationFillMode: 'both'
      }}>
