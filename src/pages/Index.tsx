            ...
            <div className="flex items-center gap-3">
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 ml-2">
