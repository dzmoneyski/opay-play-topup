	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { boxShadow: '0 0 60px hsl(var(--primary) / 0.3)' },
				...
				'pulse-glow': {
					'0%, 100%': { 
						opacity: '1',
						boxShadow: '0 0 20px hsl(var(--warning) / 0.6), 0 0 40px hsl(var(--warning) / 0.4)'
					},
					'50%': { 
						opacity: '0.8',
						boxShadow: '0 0 30px hsl(var(--warning) / 0.8), 0 0 60px hsl(var(--warning) / 0.6)'
					}
				}
			},
			animation: {
