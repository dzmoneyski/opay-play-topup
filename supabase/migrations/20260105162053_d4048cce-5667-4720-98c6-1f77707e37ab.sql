-- Ensure withdrawals always use an up-to-date balance snapshot to prevent false "insufficient balance" errors
...
BEGIN
  ...
  -- This prevents false "insufficient balance" when user_balances is stale.
