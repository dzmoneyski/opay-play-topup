-- Fix: prevent user_balances check constraint violations by clamping recalculated balance to >= 0
...
BEGIN
  ...
  -- ✅ Game topups (pending + approved) - يحجز المبلغ عند الطلب ولا يُرجع عند الموافقة
  ...
  -- ✅ Phone topups (pending + approved) - يحجز المبلغ عند الطلب ولا يُرجع عند الموافقة
  ...
  -- ✅ Prevent negative balances from breaking the CHECK constraint
