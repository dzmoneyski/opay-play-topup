...
-- إصلاح دالة create_withdrawal لاستخدام الاسم الصحيح للإعدادات
...
BEGIN
  ...
  -- ====== التحقق 7: جلب وحساب الرسوم (تصحيح اسم الإعداد) ======
  SELECT 
  ...
  WHERE setting_key = 'withdrawal_fees';  -- تصحيح: withdrawal_fees بدلاً من withdrawal_fee
