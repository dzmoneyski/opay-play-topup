-- Update approve_verification to automatically activate account and process referrals
...
BEGIN
  ...
  SET 
    ...
    is_account_activated = true  -- تفعيل الحساب تلقائياً
  ...
  IF _referred_by_code IS NOT NULL AND TRIM(_referred_by_code) != '' THEN
    ...
    IF _referrer_id IS NOT NULL THEN
      ...
      IF NOT EXISTS (
        ...
        VALUES (_referrer_id, _user_id, 'completed');
      ELSE
